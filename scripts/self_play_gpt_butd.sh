work_path=.
vqa_model=$work_path/bottom-up-attention-vqa/checkpoints/vqa_butd/model.pth
vqg_model=$work_path/checkpoints/qgen_gpt2/checkpoint-20000
...
python -u $work_path/self_play_gpt_butd.py \
        --lxrt_path $lxrt_path \
        --butd_path $butd_path \
        --vqa_model $vqa_model \
        --vqg_model $vqg_model \
