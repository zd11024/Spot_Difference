...
class LXRTEncoder(nn.Module):
    def __init__(self, args, max_seq_length, mode='x'):
        ...
        model_name_or_path = args.bert_model if args.bert_model is not None else 'bert-base-uncased'
    ...
    def forward(self, sents, feats, visual_attention_mask=None, return_attention_mask=False):
